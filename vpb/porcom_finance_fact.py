...
from .library.finance_fact import BranchFinanceFact, FinanceTree
...
class FinanceTree():
    ...
    def __init__(self):
        self.key = 'root'
        self.nodes = {}
        for node_key in ['passiva', 'activa', 'opbrengsten', 'kosten']:
...
# Define chart of accounts for Portier
PORCOM_SCHEME = (
class PorComFinanceTree(FinanceTree):
